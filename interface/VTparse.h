...
extern Const int groundtable[];
extern Const int csitable[];
extern Const int dectable[];
extern Const int eigtable[];
extern Const int esctable[];
extern Const int iestable[];
extern Const int igntable[];
extern Const int scrtable[];
extern Const int scstable[];
extern Const int mbcstable[];
extern Const int smbcstable[];
